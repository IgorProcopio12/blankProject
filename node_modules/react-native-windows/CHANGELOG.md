...
This log was last generated on Mon, 06 Sep 2021 15:06:25 GMT and should not be manually modified.

<!-- Start content -->

## 0.65.2

Mon, 06 Sep 2021 15:06:25 GMT
...
- [0.65] Consume Node-Api V8 JSI Runtime (julio.rocha@microsoft.com)
- Lib project will use the app's ExperimentalFeatures.props (asklar@microsoft.com)
...
- Integrate 0.65.0-rc.2 (ngerlem@microsoft.com)
...
- Update 0.65-stable to WinUI 2.6 (34109996+chiaramooney@users.noreply.github.com)
...
- fix filter project merge (asklar@microsoft.com)
...
- Layout wrongly overwrites width/height coming from view manager (asklar@microsoft.com)
